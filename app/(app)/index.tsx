  ...
  return (
    <View style={styles.container} testID="map-screen">
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        <View>
          <Text style={styles.brand}><Text style={styles.brandGeo}>GEO</Text>POP</Text>
      ...
      <View testID="vehicle-panel" style={[styles.listPanel, { paddingBottom: showList ? insets.bottom : 0 }]}>
        <Pressable testID="vehicle-panel-toggle" style={styles.panelHandle} onPress={() => setShowList((value) => !value)}>
...
const styles = StyleSheet.create({
  ...
  brand: { color: colors.primary, fontSize: 21, fontWeight: '900', letterSpacing: 1 },
  brandGeo: { color: '#111111' },
